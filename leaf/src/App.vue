  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div v-if="!user">
      ...
      <router-link to="/register">  <a class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue hover:bg-white mt-4 lg:mt-0">Register</a></router-link>
        ...
        <div v-if="user">
      <router-link to="/login">  <a class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue hover:bg-white mt-4 mr-2 lg:mt-0">Logout</a></router-link>
